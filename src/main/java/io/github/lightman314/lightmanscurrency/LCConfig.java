...
public final class LCConfig {
    ...
    public static class Server extends SyncedConfigFile
    {
        ...
        public final BooleanOption disableTrinketsIntegration = BooleanOption.createFalse();
        ...
        protected void setup(@NotNull ConfigBuilder builder)
        {
            ...
            builder.comment("Integration Settings").push("integration");
            
            builder.comment("Disable Trinkets integration. Set to true if you want to prevent wallets from being equipped in Trinkets slots.",
                            "This is useful if you have disabled Trinkets functionality via KubeJS or other means.",
                            "When enabled, wallets will only use the built-in wallet system.")
                    .add("disableTrinketsIntegration", this.disableTrinketsIntegration);
